...
vim.keymap.set('n', '<Leader>gg', '<cmd>DduRgInput<CR>', opt)
vim.keymap.set('n', '<Leader>gw', '<cmd>DduRgWord<CR>', opt)
-- vim.keymap.set('n', '<Leader>e', '<cmd>Ddu -name=tree<CR>', opt)
vim.keymap.set('n', '<Leader>e', "<cmd>call ddu#start({'name': 'tree','uiParams': {'filer': {'search': expand('%:p')}}})<CR>", opt)

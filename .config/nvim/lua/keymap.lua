...
vim.keymap.set('n', '<Leader>f', '<cmd>Telescope find_files previewer=false find_command=rg,--files,--hidden,--glob,!.git/*<CR>', opt)
vim.keymap.set('n', '<Leader>g', '<cmd>Telescope live_grep previewer=false<CR>', opt)
vim.keymap.set('n', '<Leader>b', '<cmd>Telescope buffers previewer=false<CR>', opt)
vim.keymap.set('n', '<Leader>t', '<cmd>Telescope filetypes previewer=false<CR>', opt)
vim.keymap.set('n', '<Leader>h', '<cmd>Telescope oldfiles previewer=false only_cwd=true<CR>', opt)
